...
const ReviewCard = (card: cardProps) => {
  ...
  return (
    <div className=" p-8 flex flex-col gap-4 w-full bg-[#ffffff] rounded-[20px]">
      <p className=" text-xl font-medium">{card.name}</p>
      {/* TODO: show status here */}
      <div className="flex justify-between items-center gap-8">
        <div className=" p-4 flex items-center gap-2 rounded-[10px] bg-[#63392c] text-white">
        ...
        {showMore ? (
          <button
            className="flex justify-center items-center p-4 rounded-[10px] bg-[#63392c] text-white h-full"
